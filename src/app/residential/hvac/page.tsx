...
export default function ResidentialHVAC() {
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white" style={{fontFamily: 'Georgia, serif'}}>
      ...
      <section className="min-h-[60vh] flex items-center justify-center py-20 px-4 bg-gradient-to-b from-[#0a0a0a] via-[#1a1a1a] to-[#0a0a0a] relative overflow-hidden pt-32">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 text-white">HVAC Services</h1>
          <p className="text-xl md:text-2xl text-gray-300 leading-relaxed">
            Professional heating, ventilation, and air conditioning services for year-round comfort
          </p>
        </div>
      </section>
      ...
      <section className="w-full py-20 px-4 bg-gradient-to-b from-[#1a1a1a] to-[#0a0a0a]">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-white mb-12 text-center">Our HVAC Services</h2>
          
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-[#2a2a2a] rounded-xl p-8 border border-orange-500/20">
              <h3 className="text-2xl font-bold text-white mb-4">Heating Services</h3>
              <p className="text-gray-400 mb-6">
                Complete heating solutions including furnace installation, repair, and maintenance. We work with all heating system types.
              </p>
              <ul className="space-y-2 text-gray-300 mb-6">
                ...
                <li className="flex items-center gap-2">
                  ...
                  <span>Ductwork Installation</span>
                </li>
              </ul>
            </div>

            <div className="bg-[#2a2a2a] rounded-xl p-8 border border-orange-500/20">
              <h3 className="text-2xl font-bold text-white mb-4">Cooling Services</h3>
              <p className="text-gray-400 mb-6">
                Air conditioning installation, repair, and maintenance services to keep your home cool and comfortable during hot months.
              </p>
              <ul className="space-y-2 text-gray-300 mb-6">
                <li className="flex items-center gap-2">
                  <svg className="w-5 h-5 text-orange-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
