    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white" style={{fontFamily: 'Georgia, serif'}}>
      ...
      <section className="min-h-[60vh] flex items-center justify-center py-20 px-4 bg-gradient-to-b from-[#0a0a0a] via-[#1a1a1a] to-[#0a0a0a] relative overflow-hidden pt-32">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 text-white">Plumbing Services</h1>
          <p className="text-xl md:text-2xl text-gray-300 leading-relaxed">
            Complete plumbing solutions for your home - installation, repair, and maintenance
          </p>
        </div>
      </section>
      ...
      <section className="w-full py-20 px-4 bg-gradient-to-b from-[#1a1a1a] to-[#0a0a0a]">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-white mb-12 text-center">Our Plumbing Services</h2>
          
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-[#2a2a2a] rounded-xl p-8 border border-orange-500/20">
              <h3 className="text-2xl font-bold text-white mb-4">Plumbing Installation</h3>
              <p className="text-gray-400 mb-6">
                Professional installation of plumbing fixtures, pipes, and systems for new construction and renovations.
              </p>
              <ul className="space-y-2 text-gray-300 mb-6">
                ...
                <li className="flex items-center gap-2">
                  ...
                  <span>Pipe Installation & Replacement</span>
                </li>
                <li className="flex items-center gap-2">
                  <svg className="w-5 h-5 text-orange-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
            ...
            <div className="bg-[#2a2a2a] rounded-xl p-8 border border-orange-500/20">
              <h3 className="text-2xl font-bold text-white mb-4">Plumbing Repair</h3>
              <p className="text-gray-400 mb-6">
                Emergency and scheduled plumbing repairs to fix leaks, clogs, and other plumbing issues quickly and efficiently.
              </p>
              <ul className="space-y-2 text-gray-300 mb-6">
                <li className="flex items-center gap-2">
                  <svg className="w-5 h-5 text-orange-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
