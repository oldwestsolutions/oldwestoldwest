    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white" style={{fontFamily: 'Georgia, serif'}}>
      ...
      <section className="min-h-[60vh] flex items-center justify-center py-20 px-4 bg-gradient-to-b from-[#0a0a0a] via-[#1a1a1a] to-[#0a0a0a] relative overflow-hidden pt-32">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 text-white">Hosting Services</h1>
          <p className="text-xl md:text-2xl text-gray-300 leading-relaxed mb-8">
            Reliable, scalable hosting solutions for your applications. From premium CPU plans to GPU-accelerated instances, we have the infrastructure you need.
          </p>
        </div>
      </section>
        ...
        <div className="bg-[#2a2a2a] rounded-xl shadow p-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-gray-300 mb-4">Yes! There are no long-term contracts. You can cancel your hosting service at any time with no penalties.</p>
