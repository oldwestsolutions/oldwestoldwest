      ...
      <section className="w-full max-w-7xl py-16 px-4">
        <div className="grid lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className="bg-[#2a2a2a] rounded-xl shadow-lg p-8 border border-gray-700 hover:border-green-500 transition-colors">
            ...
            <Link href="/rent" className="w-full bg-green-600 hover:bg-green-700 text-white py-3 rounded-lg font-semibold transition-colors block text-center">
              Get Started
            </Link>
          </div>
        ...
        <div className="bg-[#2a2a2a] rounded-xl shadow-lg p-8 mb-16">
          <h2 className="text-3xl font-bold text-center mb-8 text-white">GPU Servers</h2>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-[#1a1a1a] rounded-lg p-6">
              <h3 className="text-xl font-bold text-white mb-4">RTX 4090 Mining Server</h3>
              ...
              <ul className="space-y-2 mb-6">
                ...
                <li className="flex items-center gap-2">
                  ...
                  <span className="text-gray-300">Low Power Consumption</span>
                </li>
              </ul>
              <Link href="/rent" className="w-full bg-green-600 hover:bg-green-700 text-white py-2 rounded-lg font-semibold transition-colors block text-center">
                Rent GPU Server
              </Link>
            </div>
            <div className="bg-[#1a1a1a] rounded-lg p-6">
              <h3 className="text-xl font-bold text-white mb-4">AI Development Server</h3>
          ...
          <div className="bg-[#2a2a2a] rounded-xl shadow p-6">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-300">No setup fees or hidden costs</span>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 text-green-500 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
          ...
          <div className="bg-[#2a2a2a] rounded-xl shadow p-6">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-300">Cryptocurrency (BTC, ETH)</span>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 text-blue-500 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-300">Monthly billing available</span>
              </li>
            </ul>
          </div>
        </div>
