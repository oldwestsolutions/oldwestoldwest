    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white" style={{fontFamily: 'Georgia, serif'}}>
      ...
      <section className="min-h-screen flex items-center justify-center py-20 px-4 bg-gradient-to-b from-[#0a0a0a] via-[#1a1a1a] to-[#0a0a0a] relative overflow-hidden pt-32">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 text-white">
            Issue <span className="text-blue-400">Tracking</span>
          </h1>
          <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-3xl mx-auto">
            Comprehensive issue tracking and management. Keep your projects organized with professional bug tracking, feature requests, and task management.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-[#1a1a1a] to-[#0a0a0a]">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-12 text-white">Powerful Issue Management</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="bg-[#2a2a2a] rounded-xl p-8 border border-blue-500/20">
              ...
              <h3 className="text-xl font-bold text-white mb-4">Bug Tracking</h3>
              <p className="text-gray-400">
                Track bugs from discovery to resolution with detailed reports, priority levels, and assignment workflows.
              </p>
            </div>
            ...
            <div className="bg-[#2a2a2a] rounded-xl p-8 border border-blue-500/20">
              ...
              <p className="text-gray-400">
                Manage feature requests with voting, categorization, and roadmap integration for better product planning.
              </p>
            </div>
            ...
            <div className="bg-[#2a2a2a] rounded-xl p-8 border border-blue-500/20">
              ...
              <p className="text-gray-400">
                Organize tasks with labels, milestones, and project boards for efficient team collaboration.
              </p>
            </div>
          </div>

          <div className="bg-[#2a2a2a] rounded-2xl p-12 border border-blue-500/20">
            <h3 className="text-3xl font-bold text-white mb-6 text-center">Advanced Features</h3>
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <ul className="space-y-3 text-gray-300">
                  <li className="flex items-start gap-3">
                    ...
                    <span>Automated issue assignment based on labels</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <svg className="w-6 h-6 text-blue-400 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span>Status transitions and notifications</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <svg className="w-6 h-6 text-blue-400 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              ...
              <div>
                <h4 className="text-xl font-semibold text-blue-400 mb-4">Reporting & Analytics</h4>
                <ul className="space-y-3 text-gray-300">
                  <li className="flex items-start gap-3">
                    <svg className="w-6 h-6 text-blue-400 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span>Issue velocity and resolution metrics</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <svg className="w-6 h-6 text-blue-400 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-[#0a0a0a] to-[#1a1a1a]">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-white mb-6">Start Tracking Issues Effectively</h2>
          <p className="text-xl text-gray-300 mb-8">
            Get professional issue management for your projects.
          </p>
