...
export default function RemodelingOutdoor() {
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white" style={{fontFamily: 'Georgia, serif'}}>
      ...
      <section className="min-h-[60vh] flex items-center justify-center py-20 px-4 bg-gradient-to-b from-[#0a0a0a] via-[#1a1a1a] to-[#0a0a0a] relative overflow-hidden pt-32">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 text-white">Outdoor Services</h1>
          <p className="text-xl md:text-2xl text-gray-300 leading-relaxed">
            Transform your outdoor space with professional construction and landscaping services
          </p>
        </div>
      </section>
      ...
      <section className="w-full py-20 px-4 bg-gradient-to-b from-[#1a1a1a] to-[#0a0a0a]">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-white mb-12 text-center">Our Outdoor Services</h2>
          
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="bg-[#2a2a2a] rounded-xl p-8 border border-yellow-500/20">
              <h3 className="text-2xl font-bold text-white mb-4">Decks / Patios / Sheds</h3>
              <p className="text-gray-400 mb-6">
                Professional construction, repair, and maintenance of decks, patios, and sheds to enhance your outdoor living space.
              </p>
            ...
            <div className="bg-[#2a2a2a] rounded-xl p-8 border border-yellow-500/20">
              <h3 className="text-2xl font-bold text-white mb-4">Fencing / Gates</h3>
              <p className="text-gray-400 mb-6">
                Professional installation and repair of fencing and gates for privacy, security, and aesthetics.
              </p>
              <ul className="space-y-2 text-gray-300">
                <li className="flex items-center gap-2">
                  <svg className="w-5 h-5 text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-[#2a2a2a] rounded-xl p-8 border border-yellow-500/20">
              <h3 className="text-2xl font-bold text-white mb-4">Landscaping / Hardscaping</h3>
              <p className="text-gray-400 mb-6">
                Complete landscaping and hardscaping services to create beautiful and functional outdoor spaces.
              </p>
              <ul className="space-y-2 text-gray-300">
                <li className="flex items-center gap-2">
                  <svg className="w-5 h-5 text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <li className="flex items-center gap-2">
                  ...
                  <span>Hardscape Features</span>
                </li>
              </ul>
            </div>

            <div className="bg-[#2a2a2a] rounded-xl p-8 border border-yellow-500/20">
              <h3 className="text-2xl font-bold text-white mb-4">Gutters / Drainage</h3>
              <p className="text-gray-400 mb-6">
                Professional gutter and drainage services to protect your home from water damage.
              </p>
              <ul className="space-y-2 text-gray-300">
                <li className="flex items-center gap-2">
                  <svg className="w-5 h-5 text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
